        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form className="space-y-6">
            <div>
              ...
              <input type="text" placeholder="John Doe" className="w-full px-4 py-2 bg-white/20 border border-white/30 text-white rounded-xl 0 placeholder-gray-200  focus:outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
